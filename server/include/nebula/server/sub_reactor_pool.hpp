#ifndef NEBULA_SERVER_SUB_REACTOR_POOL_HPP
#define NEBULA_SERVER_SUB_REACTOR_POOL_HPP
...
public:
    ...
    SubReactorPool(const app::ServerConfig& config, RequestDispatcher request_dispatcher,
...
private:
    const app::ServerConfig* config_ = nullptr;
...
#endif  // NEBULA_SERVER_SUB_REACTOR_POOL_HPP
