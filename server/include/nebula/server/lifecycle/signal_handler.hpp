#ifndef NEBULA_SERVER_LIFECYCLE_SIGNAL_HANDLER_HPP
#define NEBULA_SERVER_LIFECYCLE_SIGNAL_HANDLER_HPP
...
private:
    ...
    bool drain_signal_pipe(const std::stop_token& stop) noexcept;
    void wait_loop(const std::stop_token& stop) noexcept;
...
#endif  // NEBULA_SERVER_LIFECYCLE_SIGNAL_HANDLER_HPP
