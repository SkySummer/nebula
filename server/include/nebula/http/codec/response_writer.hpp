#ifndef NEBULA_HTTP_CODEC_RESPONSE_WRITER_HPP
#define NEBULA_HTTP_CODEC_RESPONSE_WRITER_HPP
...
HttpResponse make_api_success_response(common::JsonObject data);
...
#endif  // NEBULA_HTTP_CODEC_RESPONSE_WRITER_HPP
