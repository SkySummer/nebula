#ifndef NEBULA_HTTP_ROUTING_ROUTER_HPP
#define NEBULA_HTTP_ROUTING_ROUTER_HPP
...
struct RouteContext {
    HttpRequest request;
    RouteParams params;
    std::optional<auth::UserProfile> user;
};
...
public:
    ...
    [[nodiscard]] bool requires_user() const;
...
#endif  // NEBULA_HTTP_ROUTING_ROUTER_HPP
